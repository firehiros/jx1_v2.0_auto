...
### [docs/01-build/](docs/01-build/) - Build Instructions
```
README.md                        Folder overview
...
### [docs/05-research/](docs/05-research/) - Research Notes
```
README.md                        Folder overview
...
### Phase 2 - Reverse Engineering (Complete Workflow)
**Start Here:**
